    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.error.includes('auth/configuration-not-found')) {
          setError(
            'Firebase authentication is not properly configured. Please verify the Firebase project setup.'
          )
          console.error(
            'Firebase configuration error. Please check if Authentication is enabled in the Firebase console.'
          )
        } else {
      ...
      if (error.message && error.message.includes('configuration-not-found')) {
        setError(
          'Firebase configuration error. Please ensure Authentication is enabled in your Firebase project.'
        )
      } else {
